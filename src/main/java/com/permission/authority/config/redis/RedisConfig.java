package com.permission.authority.config.redis;
...
public class RedisConfig {
    ...
    public RedisTemplate<String, Object> redisTemplate(RedisConnectionFactory
        ...
        //使用JacksonJsonRedisSerialize 替换默认序列化(默认采用的是JDK序列化)
        Jackson2JsonRedisSerializer jacksonJsonRedisSerializer = new
